...
public class PosVenta extends AuditableEntity {
    ...
    public void setPuntoVenta(PosPuntoVenta pv) { this.puntoVenta = pv; }
    
    public PosTurno getTurno() { return turno; }
    public void setTurno(PosTurno turno) { this.turno = turno; }
    
    public PosCliente getCliente() { return cliente; }
    public void setCliente(PosCliente cliente) { this.cliente = cliente; }
    
    public SysUsuario getUsuarioVendedor() { return usuarioVendedor; }
    public void setUsuarioVendedor(SysUsuario u) { this.usuarioVendedor = u; }
    ...
    public void setTotalBruto(BigDecimal t) { this.totalBruto = t; }
    
    public BigDecimal getDescuentoTotal() { return descuentoTotal; }
    public void setDescuentoTotal(BigDecimal t) { this.descuentoTotal = t; }
    
    public BigDecimal getImpuestosTotal() { return impuestosTotal; }
    public void setImpuestosTotal(BigDecimal t) { this.impuestosTotal = t; }
    
    public BigDecimal getTotalNeto() { return totalNeto; }
    public void setTotalNeto(BigDecimal t) { this.totalNeto = t; }
    ...
    public InvAlmacen getAlmacenSalida() { return almacenSalida; }
    public void setAlmacenSalida(InvAlmacen a) { this.almacenSalida = a; }
    
    public InvMovimiento getMovimiento() { return movimiento; }
    public void setMovimiento(InvMovimiento m) { this.movimiento = m; }
}
