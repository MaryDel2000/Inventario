...
public interface InvProductoVarianteRepository extends JpaRepository<InvProductoVariante, Long> {
    ...
    @org.springframework.data.jpa.repository.Query("SELECT v FROM InvProductoVariante v JOIN FETCH v.producto")
    java.util.List<InvProductoVariante> findAllWithProducto();
}
